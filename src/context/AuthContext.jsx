...
export function AuthProvider({ children }) {
  // TIP: lazy initializer again (see WishlistContext) — only reads
  // localStorage once, on first mount, not on every render.
  ...
  return (
    <AuthContext.Provider value={{ user, token, isSignedIn: !!user, login, logout }}>
      {children}
